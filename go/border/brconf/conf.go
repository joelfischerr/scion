...
type BRConf struct {
	...
	ExternalQosConfig qosloadconfig.ExternalConfig
...
func (cfg *BRConf) loadQos() error {
	...
	qConfig, err := qosloadconfig.LoadConfig(qosPath)
	if err != nil {
		return err
	}
...
func (cfg *BRConf) initQos(qconf qosloadconfig.ExternalConfig) error {
